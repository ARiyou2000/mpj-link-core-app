    ...
    <>
      <GeneralPageBody
        ...
        <div className={"h-full flex flex-col gap-6"}>
          ...
          <div
            className={
              "text-lg text-milkwhite font-normal pb-8 px-4 flex flex-col gap-4"
            }>
            <p>
            ...
            <div>
              <h3 className={"font-bold mb-1"}>پلتفرم نرم افزاری MPJ-link</h3>
              <ul
                className={
                  "list-inside [&>li]:list-disc [&>li]: [&>li]: [&>li]: [&>li]: [&>li]: "
                }>
                <li>
                  امکان مانیتور و فرمان دهی سیستم هوشمند بدون نیاز به اینترنت در
                  محدوده پوشش مودم
                </li>
